...
\begin{minipage}[t]{\emaillength\linewidth}
  % \mbox{Phone \cn{电话：}} \hspace{\stretch{1}} \mbox{+65 6516 2746} \\
  % Fax: +65 6779 5452 \\
  % Office: Block S17 6-20 \\
  \mbox{Email (research) \cn{电子邮件（科研相关）：}} \hspace{\stretch{1}} \mbox{\href{mailto:wangdong@wangd-math.xyz}{wangdong@wangd-math.xyz}} \\
  \mbox{Email (other stuff) \cn{电子邮件（其他）：}} \hspace{\stretch{1}} \mbox{\href{mailto:wangdong21@ucas.ac.cn}{wangdong21@ucas.ac.cn}} \\
  \mbox{Homepage \cn{个人主页：}} \hspace{\stretch{1}} \mbox{\href{https://www.wangd-math.xyz/}{{https://www.wangd-math.xyz/}}}
\end{minipage}
\section*{Education \cn{教育经历}}

\begin{item_list}
\item Ph.D. Mathematics, Brandeis University, 2008. \cn{\\}
  \cn{2008年于（美国）布兰戴斯大学获得博士学位}
    % Received May 16, 2010
    \begin{item_list}
    \item \textit{Advisor \cn{博士导师:}}
      Mark Adler.
    \end{item_list}
...
\cn{我从事“可积概率”研究，致力于用分析方法解决概率问题。具体来说，我关心随机矩阵和相互作用粒子系统，以及相关的可积系统、多正交多项式、黎曼—希尔伯特问题等分析问题。}

% \section*{In Preparation \cn{近期计划}}
...
\section*{Papers and Preprints \cn{论文和预印本}}

\begin{etaremune}
\item
  Zhigang Bao, Dong Wang and Yue Zhu, \href{https://arxiv.org/abs/2605.30779}{Eigenvector distribution of random matrices under critical finite-rank deformations}, \url{https://arxiv.org/abs/2605.30779}.
\item
  Dong Wang and Shuai-Xia Xu, \href{https://arxiv.org/abs/2512.20343}{Critical Hermitian matrix model with external source and Boussinesq hierarchy}, \url{https://arxiv.org/abs/2512.20343}.
\item
  Dong Wang and Shuai-Xia Xu, \href{https://arxiv.org/abs/2501.16746}{Hard to soft edge transition for the Muttalib-Borodin ensembles with integer parameter $\theta$}, \url{https://arxiv.org/abs/2501.16746}.
\item
...
\item
  Dong Wang and Dong Yao, \href{https://arxiv.org/abs/2307.03720}{Biorthogonal polynomials related to quantum transport theory of disordered wires}, \href{https://doi.org/10.1007/s00220-025-05524-x}{\textit{Comm.\ Math.\ Phys.}, 407 (2026), no.\ 24, 79pp}.
\item
...
\subsection*{Dissertation \cn{博士论文}}
\begin{itemize}
\item
  Spiked Models in Wishart Ensemble.
\end{itemize}

\section*{Teaching \cn{教学经历}}

\subsection*{National University of Singapore \cn{新加坡国立大学}}
...
\subsection*{University of Michigan \cn{密歇根大学}}
...
\subsection*{Brandeis University \cn{布兰戴斯大学}}
...
\section*{Students mentored \cn{指导学生}}

\subsection*{Master students \cn{硕士生}}

David Waugh (NUS 2015)

\subsection*{Selected undergraduate students \cn{优秀本科生}}

Mark Ng Say-Yao (NUS Undergraduate Research Opportunities Programme in Science (UROPS), winner of 2015/16 CRISP award)

% \section*{Conference and Seminar Presentations \cn{会议和讨论班报告}}

% \begin{item_list}
% \item
%   \href{http://math0.bnu.edu.cn/~hehui/webinar20210318.pdf}{Tsinghua-PKU-BNU Probability Webinar, \cn{清北师概率网上讨论班，}}\cn{线上，北京师范大学，2020年3月} Beijing Normal University, online, March 2021.
% \item
...
% \item
%   \href{https://math.fudan.edu.cn/show.aspx?info_lb=765&flag=527&info_id=7048}{Maths Seminar, \cn{数学综合报告会，}}\cn{线上，复旦大学，2020年11月} Fudan University, online, November 2020. 
% \item
...
\section*{Professional Activities \cn{专业相关活动}}

\begin{item_list}
% \item Reviewer for \cn{曾为以下杂志审稿} \\
...
\item Co-organizer of the workshop \cn{（共同）组织学术研讨会} \\
...
\item Co-organizer of the seminar \cn{（共同）组织讨论班} \\
...
\section*{Grants \cn{基金申请}}

\begin{item_list}
\item 
  Chinese NSFC grant (participant) \cn{中国基金委面上项目（参与） \\}
  11871425
\item
  Singapore AcRF Tier 1 Grant \cn{新加坡教育部Tier 1项目 \\}
  R-146-000-262-114
\item
  Singapore AcRF Tier 1 Grant \cn{新加坡教育部Tier 1项目 \\}
  R-146-000-217-112
\item
  Start-up grant in National University of Singapore \cn{新加坡国立大学启动经费 \\}
  R-146-000-164-133
